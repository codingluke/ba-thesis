...
Die Eingabeverknüpfungen (in Abbildung \ref{perzeptron-ki-norvig} als $a$ angegeben), werden häufig auch als Eingabevektor $X$ bezeichnet. Die Ziffer $a$ wurde gewählt, da der Eingabevektor sich in einem Netz aus Ausgabeverknüpfungen zusammenstellen kann.
