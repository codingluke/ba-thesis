...
\usepackage{placeins} % provides \textsubscript
...
\captionsetup{format=listing,singlelinecheck=false,labelsep=space,labelfont=bf,justification=centering,position=below}
...
\setkeys{Gin}{width=\ScaleWidthIfNeeded,height=\ScaleHeightIfNeeded, resolution=72,keepaspectratio}%
%\setkeys{Gin}{resolution=1000,keepaspectratio}%
