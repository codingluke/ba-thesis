...
\DeclareCaptionFormat{listings}{#1#2#3}
\captionsetup{format=listings,singlelinecheck=false,labelsep=space,labelfont=bf,justification=centering,position=below}
